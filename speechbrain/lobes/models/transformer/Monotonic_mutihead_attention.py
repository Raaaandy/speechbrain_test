...
from fairseq.examples.simultaneous_translation.utils.p_choose_strategy import (
    learnable_p_choose,
    waitk_p_choose
)

from fairseq.examples.simultaneous_translation.utils.monotonic_attention import (
