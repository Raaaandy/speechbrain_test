...
class MonotonicAttention(MultiheadAttention):
    ...
    def monotonic_attention_process_train(
        ...
        print("soft_attention", self.soft_attention, "/gscratch/intelligentsystems/randy/fairseq/examples/simultaneous_translation/modules/monotonic_multihead_attention.py")
        if self.soft_attention:
            soft_energy = self.energy_from_qk(
                query,
                key,
